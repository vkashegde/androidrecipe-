...
public class StartersActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Dish dish1 = new Dish("Mushroom and tofu maki","TOasted seaweed wrapped around sishi rice, filled with chestnut mushroom and smoked tofu",345);
//        dish1.title = "Mushroom and tofu maki";
//        dish1.description = "TOasted seaweed wrapped around sishi rice, filled with chestnut mushroom and smoked tofu";
//        dish1.price = 234;
